...
const state = {
  ...
  shaoJieYuanLiao3:[531,532,533,534,535,536,537,538,539,540], // 烧结原料3
  shaoJie3:[501,502,503,504,505,506,507,508,509,510],//烧结工3
  qiCheJiaoLian3:[2991,2992,2993,2994,2995,2996,2997,2998,2999,3000],//汽车
  lianZhuGong3:[161,162,163,164,165,166,167,168,169,170],//连铸工3
  anQuan2:[],
  subqu:1,
  userName:'',
  userNum: '',
